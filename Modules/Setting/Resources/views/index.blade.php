                        ...
                        <div class="row">
                                ...
                                <div class="white_box_30px mb_30">
                                    <ul class="nav custom_nav" id="myTab" role="tablist">
                                        ...
                                        @if(permissionCheck('smtp_setting.index'))
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="SMTP-tab" data-toggle="tab" href="#SMTP"
                                        ...
                                        @if(permissionCheck('cron.index'))
                                            <li class="nav-item">
                                                <a class="nav-link" id="CORN-tab" data-toggle="tab" href="#CORN"
                                                   role="tab" aria-controls="contact"
                                                   aria-selected="false">{{ __('setting.CRON') }}</a>
                                            </li>
                                        @endif
                                        ...
                                        @if(permissionCheck('login_bg_image.index'))
                                            <li class="nav-item">
                                                <a class="nav-link" id="SMS-tab" data-toggle="tab" href="#SMS"
                                                   role="tab" aria-controls="contact"
                                                   aria-selected="false">{{ __('setting.Login Backgroud Image') }}</a>
                                            </li>
                                        @endif

                                        @if(permissionCheck('email_template_settings.index'))
                                            <li class="nav-item submenu_parent">
                                                <a class="nav-link submenu_toggler d-flex jusify-content-between align-itesm-center"
                                                   aria-controls="contact" aria-selected="false">
                                                    <span>{{ __('setting.Email Template') }}</span> <i
                                                        ...
                                                        @if(!$template->module or moduleStatusCheck($template->module))
                                                            <li class="nav-item">
                                                                <a class="nav-link tab-link"
                                                                   id="{{ $template->type }}-tab"
                                                                   data-toggle="tab" href="#{{ $template->type }}"
                                                                   role="tab" aria-controls="{{ $template->type }}"
                                                                   aria-selected="false">{{ __('setting.'.$template->name) }}</a>
                                                            </li>
                                                        @endif
                                                    @endforeach
                                                </ul>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="tab-content " id="myTabContent">
                                    <!-- General -->
                                    @if(permissionCheck('general_setting.index'))
                                        <div class="tab-pane fade white_box_30px active show" id="General"
                                    ...
                                    <!-- SMTP  -->
                                        <div class="tab-pane fade white_box_30px" id="SMTP" role="tabpanel"
                                    ...
                                    @if(permissionCheck('cron.index'))
                                    <!-- SMTP  -->
                                        <div class="tab-pane fade white_box_30px" id="CORN" role="tabpanel"
                                             aria-labelledby="CORN-tab">
