...
class ExpenseInvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('finance::invoice.expense.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('finance::invoice.expense.create', $preRequisite);
    }

    public function store(InvoiceRequest $request)
    {
        $model = $this->invoiceService->store(array_merge($request->all(), ['come_from' => 'expense_invoice', 'type' => 'out']));
    ...
    public function edit($id)
    {
        ...
        return view('finance::invoice.expense.edit', $preRequisite);
    }
    ...
    {
        $model = $this->invoiceService->update(array_merge($request->all(), ['come_from' => 'expense_invoice', 'type' => 'out']), $id);
        return response()->json(['message' => trans('finance.'. ucfirst($request->invoice_type) .' Invoice Updated Successful'), 'goto' => route('invoice.expenses.index'), 'window' => route('invoice.print', $model->id)]);
    }
